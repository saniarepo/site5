...
/**
* получение массива объектов полков для отправки на сервер для расчета окружения
* @param game объект игры
...
/**
* получение массива объектов баз для отправки на сервер для расчета окружения
* @param game объект игры
